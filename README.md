...
ltvm create     <name>          Create a VM (idempotent; needs sudo)
ltvm start      <name>          Boot a stopped VM (needs sudo)
ltvm stop|destroy <name>        Halt / remove a VM
